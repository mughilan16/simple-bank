...
// Source: github.com/mughilan16/simplebank/db/sqlc (interfaces: Store)
//
...
// ListEntires mocks base method.
func (m *MockStore) ListEntires(arg0 context.Context, arg1 db.ListEntiresParams) ([]db.Entry, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListEntires", arg0, arg1)
	ret0, _ := ret[0].([]db.Entry)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListEntires indicates an expected call of ListEntires.
func (mr *MockStoreMockRecorder) ListEntires(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListEntires", reflect.TypeOf((*MockStore)(nil).ListEntires), arg0, arg1)
}
